    ...
    <>
      <div className="px-6 sm:max-w-5xl mx-auto sm:h-screen">
        <Popover>
          <nav>
            <div className="flex justify-between items-center py-6 md:justify-between md:space-x-10">
              ...
              <div className="-mr-2 -my-2 md:hidden">
                <Popover.Button className="rounded-md p-2 bg-yellow-100 inline-flex items-center justify-center text-gray-100 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-green-100">
              ...
              <Popover.Group as="nav" className="hidden items-center md:flex space-x-10">
                ...
                <div className="flex flex-row">
                  ...
                  <Link href="/hearts">
                    <button className="group flex items-center transition-all duration-500 ease-in-out hover:bg-yellow-200 rounded-2xl text-black py-3 px-6 font-bold text-base border-2 border-black leading-6">
                      <svg className="stroke-transparent group-hover:stroke-yellow-100" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          >
            <Popover.Panel focus className="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
              <div className="rounded-lg shadow-lg ring-1 ring-green-100 ring-opacity-5 bg-yellow-100 divide-y-2 divide-gray-50">
                <div className="pt-5 pb-6 px-5">
                  ...
                  <div className="mt-6">
                    <nav className="grid gap-y-4">
                      ...
                      <button className="bg-white hover:bg-yellow-200 flex items-center transition-all duration-500 ease-in-out rounded-2xl text-black py-3 px-6 font-bold text-base border-2 leading-6" onClick={() => activate()}>
                        {active
                          ? account.substring(0, 6) +
                          "..." +
                          account.substring(account.length - 4, account.length)
          ...
          <div className="container mx-auto lg:grid grid-cols-3 grid-rows-1 sm:flex pt-8 gap-4">
            <div className="row-span-2 col-span-0">
              ...
              <p className="leading-6 text-base font-semibold my-6">Get your self a Yellow Heart and help<br />
                ...
                Know more about Fantom Hearts <Link href="/about"><span className="text-yellow-200 font-bold cursor-pointer">here</span></Link>.</p>
        ...
        <footer className="flex flex-col w-full items-center justify-center my-8">
          <div className="">
            <a href="https://twitter.com/ftmhearts">
              <button className="mr-2 text-black hover:text-yellow-100 focus:bg-gray-300 focus:ring-2 focus:ring-offset-2 focus:ring-gray-700 focus:outline-none bg-white rounded-2xl p-2">
